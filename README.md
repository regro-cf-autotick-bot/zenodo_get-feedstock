...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/zenodo_get-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12311&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/zenodo_get-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `zenodo_get` can be installed with:

```
conda install zenodo_get
```

It is possible to list all of the versions of `zenodo_get` available on your platform with:
